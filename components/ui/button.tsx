   ...
   "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-zinc-950 disabled:pointer-events-none disabled:opacity-50 dark:focus-visible:ring-zinc-300",
   {
      variants: {
         variant: {
            ...
            destructive:
               "bg-primary text-zinc-50 shadow-sm hover:bg-primary/90 dark:primary dark:text-zinc-50 dark:hover:bg-primary/90",
            outline:
               "border border-primary bg-white shadow-sm hover:bg-primary hover:text-zinc-900 dark:border-primary dark:bg-primary dark:hover:bg-primary dark:hover:text-zinc-50",
            secondary:
